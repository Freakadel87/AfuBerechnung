...
AfuBerechnungVerlaengerungsSpule::AfuBerechnungVerlaengerungsSpule(QWidget *parent) : QDialog(parent)
{
    ...
    EditHoeheDipol->setToolTip("Geben Sie hier die Antennenhöhe in [m] ein.");
    ...
    EditDickeDraht->setToolTip("Geben Sie hier die Dicke des Drahtes in [mm] ein.");
    ...
    EditLaengeSeite->setToolTip("Geben Sie hier die Seitenlänge in [m] ein.");
    ...
    EditPosSpule->setToolTip("Geben Sie hier die Position der Spule in [m] an.");
    ...
    EditFrequenz->setToolTip("Geben Sie hier die Frequenz in [MHz] ein.");
    ...
    EditZNull->setToolTip("Geben Sie hier den Z-0 in [Ohm] an.");
    ...
    EditWinkelX1->setToolTip("Geben Sie hier den Winkel in [GRAD] an.");
    ...
    EditWinkelX2->setToolTip("Geben Sie hier den Winkel in [GRAD] an.");
    ...
    EditLambda->setToolTip("Geben Sie hier die Wellenlänge in Lambda an.");
